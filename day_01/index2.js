...
const data = fs.readFileSync(__dirname + '/data', 'utf-8').split('\n');
...
lines.forEach(line => {
  ...
  // write to file called data2 the line, the first number and the last number
  fs.appendFileSync(__dirname + '/data2', Buffer.from(`${firstNumber} ${lastNumber} - ${line}`))

  console.log(`[INFO] firstNumber, lastNumber`, firstNumber, lastNumber, line)
